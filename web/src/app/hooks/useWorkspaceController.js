...
export function useWorkspaceController({
  ...
  const sidePanelProps = {
    ...
    filePanelProps: {
      ...
      fileEditorContent: panels.fileEditorContent,
      fileEditorError: panels.fileEditorError,
      fileEditorPath: panels.fileEditorPath,
      fileEditorSavedContent: panels.fileEditorSavedContent,
      fileEditorSaving: panels.fileEditorSaving,
      fileEditorSize: panels.fileEditorSize,
      ...
      onSaveFileEditor: panels.saveFileEditor,
      onFileEditorContentChange: panels.setFileEditorContent,
      selectedProjectId: selectedProject?.id,
    },
    gitPanelProps: {
